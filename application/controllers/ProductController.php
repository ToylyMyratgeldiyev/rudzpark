...
class ProductController extends CI_Controller
{
	...
	public function tablet($id)
	{
		...
		$this->load->view('pages/product_tablet',$data);
	}
	...
	public function laptop($id)
	{
		...
		$this->load->view('pages/product_laptop',$data);
	}
	...
	public function earphone($id)
	{
		...
		$this->load->view('pages/product_earphone',$data);
	}
	...
	public function tv($id)
	{
		...
		$this->load->view('pages/product_tv',$data);
	}
}

...
class ProductsController extends CI_Controller
{
	...
	public function tablets()
	{
		...
		$this->load->view('pages/catalog_tablets.php',$data);
	}
	...
	public function earphone()
	{
		...
		$this->load->view('pages/catalog_earphones.php',$data);
	}
	...
	public function laptops()
	{
		...
		$this->load->view('pages/catalog_laptops.php',$data);
	}
	...
	public function tv()
	{
		...
		$this->load->view('pages/catalog_tv.php',$data);
	}
}
